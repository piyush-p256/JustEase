...
const clients: Client[] = [
  {
    ...
    caseDescription: "Intellectual property dispute",
  },
  {
    ...
    caseDescription: "Employment contract negotiation",
  },
  {
    ...
    caseDescription: "Copyright infringement case",
  },
  {
    ...
    caseDescription: "Patent application",
  },
  {
  ...
  },
  {
    ...
    caseDescription: "Medical malpractice suit",
  },
  {
    ...
    caseDescription: "Contract dispute resolution",
  },
  {
    ...
    caseDescription: "Software licensing agreement",
  },
]
        ...
        <Table>
          <TableHeader>
            <TableRow className="border-gray-700 hover:bg-[#2a325a]">
              ...
              <TableHead className="text-gray-400">Case Description</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {clients.map((client) => (
              <TableRow key={client.id} className="border-gray-700 hover:bg-[#2a325a]">
                ...
                <TableCell className="text-sm text-gray-300">{client.caseDescription}</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
