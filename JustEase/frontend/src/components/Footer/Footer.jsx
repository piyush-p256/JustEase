...
const Footer = () => {
  ...
  return <footer className='pb-16 pt-10 bg-amber-50' >
    <div className="container ">
      <div className="flex justify-between flex-col md:flex-row flex-wrap gap-[30px]">
        <div>
          <img className='h-[200px] w-[350px]' src={logo} alt="" />
          <p className='text-[16px] leading-7 font-[400] text-textColor mt-4'>Copyright {year} developed by Piyush, Shubham, Shriyansh, Tijil. All rights reserved.</p>
