  ...
  return <section className="px-5 lg:px-0">
    <div className="w-full max-w-[570px] mx-auto rounded-lg shadow-md md:p-10">
      ...
      <form className="py-4 md:py-0">
        ...
        {/* <div className="mt-7">
          <button type="submit" className="w-full bg-primaryColor text-white text-[18px] leading-[30px] rounded-lg px-4 py-3"><a href="http://localhost:3000/dashboard">Login</a></button>
        </div> */}
        <a href="http://localhost:3000/dashboard" target="_blank">
          <img src={loginImage} className="w-full h-[100px] w-[100px] rounded-lg"/>
      </a>
